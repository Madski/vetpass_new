...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO customers (owner_name, owner_surname, animal_type, phone_number, email, password, status)
            VALUES ('$owner_name', '$owner_surname', '$animal_type', '$phone_number', '$email', '$password', 'pending')";
